...
L.CASTBAR_COUNTDOWN_desc = "활성화하면, 초읽기 중 마지막 5초에 음성 및 시각 효과가 추가됩니다.If enabled, a vocal and visual countdown will be added for the last 5 seconds of the cast bars."
L.INFOBOX = L.infobox
...
L.PRIVATE = "개인 오라"
L.PRIVATE_desc = "개인 오라는 일반적으로 추적되지 않지만 '나에게' 소리(경고)는 소리 탭에서 설정이 가능합니다."
