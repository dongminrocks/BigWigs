...
L.CASTBAR_COUNTDOWN = "초읽기(시전바만)Countdown (cast bars only)"
L.CASTBAR_COUNTDOWN_desc = "활성화 시, 시전바 마지막 5초동안 음성 및 시각적 효과가 표시될 것입니다."
L.INFOBOX = L.infobox
...
L.PRIVATE = "개인 오라"
L.PRIVATE_desc = "일반적으로 개인 오라는 추적되지 않지만, "나에게"소리(경고)는 소리 탭에서 설정할 수 있습니다."
